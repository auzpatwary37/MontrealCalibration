 ...
 * @author mrieser
 */
public class FacilitiesWriterV1 extends MatsimXmlWriter implements MatsimWriter {
    ...
    public static void main(String[] args) {
    	...
    	config.facilities().setInputFile("data\\facilities_loc.xml.gz");
    	
		ActivityFacilities f = ScenarioUtils.loadScenario(config).getActivityFacilities();
		new FacilitiesWriter(f).writeV1("data\\facilities_loc_v1.xml.gz");
	}
